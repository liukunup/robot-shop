...
type UserService interface {
	...
	GetMenuTree(ctx context.Context, uid uint) (*v1.DynamicMenuResponseData, error)
...
func (s *userService) GetMenuTree(ctx context.Context, uid uint) (*v1.DynamicMenuResponseData, error) {
	// 获取菜单列表
