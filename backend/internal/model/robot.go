...
type Robot struct {
	...
	Webhook  string `gorm:"type:varchar(255);comment:'通知地址'"`
	Callback string `gorm:"type:varchar(255);comment:'回调地址'"`
	Enabled  bool   `gorm:"type:tinyint(1);not null;comment:'是否启用'"`
