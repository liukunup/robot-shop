...
type UserRepository interface {
	ListUsers(ctx context.Context, req *v1.UserSearchRequest) ([]model.User, int64, error)
	UserCreate(ctx context.Context, user *model.User) error
	UserUpdate(ctx context.Context, uid uint, data map[string]interface{}) error
	...
	// Permission
	GetUserPermission(ctx context.Context, uid uint) ([][]string, error)
}
...
func (r *userRepository) ListUsers(ctx context.Context, req *v1.UserSearchRequest) ([]model.User, int64, error) {
	var list []model.User
	var total int64
...
func (r *userRepository) UserUpdate(ctx context.Context, uid uint, data map[string]interface{}) error {
	return r.DB(ctx).Model(&model.User{}).Where("id = ?", uid).Updates(data).Error
}

func (r *userRepository) UserDelete(ctx context.Context, uid uint) error {
...
func (r *userRepository) GetUserPermission(ctx context.Context, uid uint) ([][]string, error) {
